    ...
    var Config = /** @class */ (function () {
      ...
      Config.create = function (config) {
        Config.VERIFICATION_TYPE_DEFAULT =
          config.verificationType || Config.VERIFICATION_TYPE_DEFAULT;
        Config.IFRAME_SELECTOR_ID =
          config.iframeSelectorId || Config.IFRAME_SELECTOR_ID;
        Config.IFRAME_LOCATION_URL =
          config.iframeLocationUrl || Config.IFRAME_LOCATION_URL;
      };
      ...
      Config.EVENT_ON_INITIAL_VERIFICATION_SUCCESS =
        "avs.onInitialVerificationSuccess";
      Config.EVENT_ON_INITIAL_VERIFICATION_NOT_FOUND =
        "avs.onInitialVerificationNotFound";
      Config.EVENT_ON_INITIAL_VERIFICATION_FATAL_ERROR =
