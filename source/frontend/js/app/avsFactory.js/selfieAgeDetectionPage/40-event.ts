      ...
      public static init(): void {
        ...
        instance.event.on(
          ...
          (event: Avs.Event.Listener) => {
            ...
            instance.ui.SelfieAgeDetectionLoadingLabelArea.setContent(
              "All verifications are performed locally "
            );
            instance.ui.SelfieAgeDetectionLoadingLabelPercentCounter.setValue(
              0
            );
