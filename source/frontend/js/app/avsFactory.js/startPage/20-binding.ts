    ...
    export class Binding {
      public static init(): void {
        ...
        instance.ui.TermsAndConditionsCheckbox.onChange(() => {
          instance.entity.VerificationStepGlobal.termsAndConditionAgreement =
            instance.ui.TermsAndConditionsCheckbox.states.value;
          Avs.Helper.Common.setLocalStorageValue(
            Config.KEY_LOCAL_STORAGE_TERMS_AGREED,
            instance.ui.TermsAndConditionsCheckbox.states.value
          );
        });
        ...
        instance.ui.ErrorMessageAdditionalTextArea.element.on(
          "click",
          "a",
          () => {
