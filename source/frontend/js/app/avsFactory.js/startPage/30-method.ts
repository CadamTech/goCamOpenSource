    ...
    export class Method {
      public static init(): void {
        ...
        instance.entity.VerificationStepGlobal.verificationType =
          Config.VERIFICATION_TYPE_DEFAULT;
        ...
        if (
          !Avs.Helper.Common.isWebrtcSupported() &&
        ...
        if (
          Config.VERIFICATION_VERSION == Config.VERIFICATION_VERSION_IFRAME_V1
        ) {
      ...
      public static applyPartnerColor() {
        if (Config.PARTNER_COLOR_CONFIG !== null) {
          if (
            typeof Config.PARTNER_COLOR_CONFIG.body.foregroundCallToAction ===
            "undefined"
          ) {
            Config.PARTNER_COLOR_CONFIG.body.foregroundCallToAction =
              Config.PARTNER_COLOR_CONFIG.body.foreground;
          }
          ...
          $(
            `<style type='text/css'>
							...
							#avsMainContainer .page.layoutDocumentProcessing .processArea .checkOutList .checkOutItem .statusIcon {
								background-color: ` +
              Config.PARTNER_COLOR_CONFIG.body.background +
              `;
								color: ` +
              Config.PARTNER_COLOR_CONFIG.body.foreground +
              `;
              ...
              `;
							...
							#avsMainContainer .page .iconArea .iconItem.isSelected .iconImage svg {
								fill: ` +
              Config.PARTNER_COLOR_CONFIG.body.button.foregroundCallToAction +
              `;
							}
              ...
              `;
								background-color: ` +
              Config.PARTNER_COLOR_CONFIG.body.button.background +
              `;
								border-color: ` +
              Avs.Helper.Common.hexToRgbA(
                Config.PARTNER_COLOR_CONFIG.body.button.background,
                0.4
              ) +
              `;
							...
							#avsMainContainer .page .introIcon.layoutGreen {
								fill: ` +
              Config.PARTNER_COLOR_CONFIG.body.button.foreground +
              `;
								background-color: ` +
              Config.PARTNER_COLOR_CONFIG.body.button.background +
              `;
      ...
      public static setScreenOrientation() {
        Config.MAIN_CONTAINER_LAYER.removeClass(
          Avs.Helper.ResponsiveElements.DEVICE_ORIENTATION_PORTRAIT
        );
        Config.MAIN_CONTAINER_LAYER.removeClass(
          Avs.Helper.ResponsiveElements.DEVICE_ORIENTATION_LANDSCAPE
        );

        let screenOrientation =
          Avs.Helper.ResponsiveElements.getDeviceOrientation();
        instance.entity.VerificationStepGlobal.screenOrientation =
          screenOrientation;
      ...
      public static preloadFaceApiResources() {
        ...
        let faceApiPreloader = new Avs.Helper.FilePreloader(
          [
            SelfieAgeDetectionPage.Config.FACE_API_WEIGHTS_PATH +
              "tiny_face_detector_model-weights_manifest.json",
            SelfieAgeDetectionPage.Config.FACE_API_WEIGHTS_PATH +
              "tiny_face_detector_model-shard1",
            SelfieAgeDetectionPage.Config.FACE_API_WEIGHTS_PATH +
      ...
      public static preloadTesseractResources() {
        ...
        let tesseractPreloader = new Avs.Helper.FilePreloader(
          [
            ...
            ScanIdAgeVerificationPage.Config.TESSERACT_LANGUAGE_PATH +
              "/fra.traineddata.gz",
          ],
          instance.event,
      ...
      public static renderError(errorCode: number, errorMessage: string) {
        ...
        instance.ui.ErrorMessageTextArea.setContent(
        ...
        switch (errorCode) {
          ...
          case 25047:
            ...
            instance.ui.ErrorMessageAdditionalTextArea.setContent(
              'Make sure the webcam access it\'s not blocked, <a href="/help/webcamAccess">click here for help</a>'
            );
