namespace AvsFactory {
  export namespace StartPage {
    export class Config {
      ...
      public static SELFIE_AGE_DETECTION_INTRO_LAYER_SELECTOR: string =
        "#selfieAgeDetectionIntro";
      public static SELFIE_AGE_DETECTION_PAGE_LAYER_SELECTOR: string =
        "#selfieAgeDetectionPage";
      public static SCAN_ID_AGE_VERIFICATION_INTRO_LAYER_SELECTOR: string =
        "#scanIdAgeVerificationIntro";
      public static SCAN_ID_AGE_VERIFICATION_PAGE_LAYER_SELECTOR: string =
        "#scanIdAgeVerificationPage";
      public static RESULT_PAGE_SUCCESS_LAYER_SELECTOR: string =
        "#resultPageSuccess";
      ...
      public static SELFIE_AGE_DETECTION_INTRO_LAYER = $(
        Config.SELFIE_AGE_DETECTION_INTRO_LAYER_SELECTOR
      );
      public static SELFIE_AGE_DETECTION_PAGE_LAYER = $(
        Config.SELFIE_AGE_DETECTION_PAGE_LAYER_SELECTOR
      );
      public static SCAN_ID_AGE_VERIFICATION_INTRO_LAYER = $(
        Config.SCAN_ID_AGE_VERIFICATION_INTRO_LAYER_SELECTOR
      );
      public static SCAN_ID_AGE_VERIFICATION_PAGE_LAYER = $(
        Config.SCAN_ID_AGE_VERIFICATION_PAGE_LAYER_SELECTOR
      );
      public static RESULT_PAGE_SUCCESS_LAYER = $(
        Config.RESULT_PAGE_SUCCESS_LAYER_SELECTOR
      );
      public static RESULT_PAGE_FAIL_LAYER = $(
        Config.RESULT_PAGE_FAIL_LAYER_SELECTOR
      );

      public static FACE_API_PRELOADER_NAME = "faceApiIncludes";
      public static TESSERACT_PRELOADER_NAME = "tesseractIncludes";

      public static VERIFICATION_TYPE_DEFAULT =
        Avs.Entity.VerificationStepGlobal
      ...
      public static EVENT_ON_INITIAL_VERIFICATION_SUCCESS =
        "avs.onInitialVerificationSuccess";
      public static EVENT_ON_INITIAL_VERIFICATION_ERROR =
        "avs.onInitialVerificationError";
      public static EVENT_ON_INITIAL_VERIFICATION_FATAL_ERROR =
        "avs.onInitialVerificationFatalError";
      ...
      public static VERIFICATION_VERSION =
        Config.VERIFICATION_VERSION_STANDARD_V1;

      public static SESSION_ID: string | null = null;
      public static PARTNER_COLOR_CONFIG: IStartPageConfigPartnerColorConfig | null =
        null;
      ...
      public static KEY_LOCAL_STORAGE_TERMS_AGREED =
        "GoCamLocalStorageTermsWereAgreed";
